...
#include "avl.h"
static void __left_rotate(struct avl_node *n, struct avl_node *&root)
{
...
static void __right_rotate(struct avl_node *n, struct avl_node *&root)
{
	struct avl_node *parent = n->p;
...
static inline void avl_lr_rotate(struct avl_node *parent, struct avl_node *&r)
{
	__left_rotate(parent->l, r);
	__right_rotate(parent, r);
}
static inline void avl_rl_rotate(struct avl_node *parent, struct avl_node *&r)
{
...
static void avl_fixup_del(struct avl_node *&r, struct avl_node *x, bool left)
{
	struct avl_node *parent;
	struct avl_node *child;
	struct avl_node *gc;
